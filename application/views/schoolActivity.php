...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/fonts/th_k2d_july8.css" />
...
<nav class="ck rj aeq ro vq app-navbar">
  ...
  <div class="collapse f" id="navbarResponsive">
    <ul class="navbar-nav ain">
      <li class="qx active">
        <a class="qv" href="#">Home <span class="aet">(current)</span></a>
      </li>
      <li class="qx">
        <a class="qv" href="#">กิจกรรมหลักสูตร</a>
      </li>
      <li class="qx">
        <a class="qv" href="<?php echo site_url('welcome/stdActivity'); ?>">ประวัติกิจกรรมของนักศึกษา</a>
      </li>
  ...
  <div class="dq">
    <div class="fh">
      <div class="rp bqr agk">
        <div class="rv" style="background-image: url(assets/img/blackblue8.jpg);"></div>
        <div class="rq awx">
          <a href="profile/index.html">
            <img
              class="bqs"
              src="assets/img/581222222.png">
          </a>
